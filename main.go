...
import (
	...
	infrastructurev1alpha3 "github.com/abhi4uiec/cluster-api-provider-mailgun/api/v1alpha3"
	"github.com/abhi4uiec/cluster-api-provider-mailgun/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "3398a704.cluster.x-k8s.io",
	...
	domain := "sandbox8cab7d6fa6464cdb98ccfd69d8fff10c.mailgun.org" //os.Getenv("MAILGUN_DOMAIN")
	if domain == "" {
		setupLog.Info("missing required env MAILGUN_DOMAIN")
		os.Exit(1)
	}

	apiKey := "0267ed0bf07038256b396a0da98e21a0-b0ed5083-ec3f843b" //os.Getenv("MAILGUN_API_KEY")
	if apiKey == "" {
		setupLog.Info("missing required env MAILGUN_API_KEY")
		os.Exit(1)
	}

	recipient := "abhu4u.iec@gmail.com" //os.Getenv("MAIL_RECIPIENT")
	if recipient == "" {
